...
export function Details (){
    ...
    async function handleCodeShare(){
        Share.share({message: poolDetails.code});
    }
        ...
        <VStack flex={1} bgColor="gray.900">
            ...
            <VStack px={5} flex={1}>
                ...
                <HStack bgColor="gray.800" p={1} rounded="sm" mb={5}>
                    <Option title="Seus palpites" onPress={() => setOptionSelected("Seus palpites")} isSelected={optionSelected==="Seus palpites"}/>
                    <Option title="Ranking do Grupo" onPress={() => setOptionSelected("Ranking do Grupo")} isSelected={optionSelected==="Ranking do Grupo"}/>
                </HStack>
